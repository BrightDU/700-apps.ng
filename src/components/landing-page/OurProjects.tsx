...
export const OurProjects = () => {
    return (
        <section className=" mx-auto ">
            <div className="bg-[#02A4EF] py-[120px] gap-[232px] flex items-center justify-center rounded-t-[96px]">
                <p className="text-white text-[32px]/[48px] font-bold">Innovate. Integrate. Elevate. <br />
                ...
                <div className="relative">
                    ...
                    <p className="text-white text-[24px]/[24px] font-semibold">Connect with us now</p>
                </div>
            </div>
            <div className="flex flex-col mt-[64px]">
                <h2 className="text-[#006494] text-[48px]/[54px] text-center font-semibold mb-[13px]">Our Projects</h2>
                <p className=" text-center font-medium text-[32px]/[40px]">Explore how we&apos;ve helped businesses <br />
